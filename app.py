...
def predict_tb():
    try:
        ...
        generate_gradcam(model, img_array, filepath, 'conv5_block3_out')
...
def predictAction():
    # Save or process form data here if needed
...
def predict_stroke():
    try:
        ...
        generate_gradcam(model, img_array, filepath, 'conv4_block6_out')
...
def generate_gradcam(model, img_array, img_path, layer_name='conv4_block6_out'):
    ...
    cam_path = os.path.join(app.config['UPLOAD_FOLDER'], 'gradcam.jpg')
